...
export const CATEGORIES = [
  ...
  { id: 'schnitzel',      label: 'Schnitzel',       emoji: '🍽️' },
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id:'107',  number:'107',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel',                   description:'Mit frischer Zitrone',                                                            sizes:S(11.50), tags:['Klassiker'] },
  { id:'108',  number:'108',  category:'schnitzel', emoji:'🍽️', name:'Jägerschnitzel',              description:'Mit Champignons und Sahne',                                                       sizes:S(13.00), tags:['Fleisch'] },
  { id:'108a', number:'108a', category:'schnitzel', emoji:'🍽️', name:'Jägerschnitzel Hollandaise',  description:'Mit Champignons und Hollandaise',                                                 sizes:S(13.50), tags:['Fleisch'] },
  { id:'109',  number:'109',  category:'schnitzel', emoji:'🍽️', name:'Zigeunerschnitzel',           description:'Mit Zigeunersauce',                                                               sizes:S(13.00), tags:['Scharf'], isSpicy:true },
  { id:'110',  number:'110',  category:'schnitzel', emoji:'🍽️', name:'Bolognese Schnitzel',         description:'Mit Schinken und Käse überbacken',                                                sizes:S(13.50), tags:['Fleisch'] },
  { id:'111',  number:'111',  category:'schnitzel', emoji:'🍽️', name:'Hawaii Schnitzel',            description:'Mit Schinken, Ananas und Käse überbacken',                                        sizes:S(13.00), tags:['Fleisch'] },
  { id:'111a', number:'111a', category:'schnitzel', emoji:'🍽️', name:'Hawaii Schnitzel Hollandaise',description:'Mit Schinken, Ananas, Hollandaise und Käse überbacken',                           sizes:S(14.00), tags:['Fleisch'] },
  { id:'112',  number:'112',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel Gamberi',           description:'Mit Krabben, Knoblauch, Krabbensauce',                                            sizes:S(14.50), tags:['Fisch'] },
  { id:'113',  number:'113',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel Spargel',           description:'Schinken, Spargel, Sahne, Käse überbacken',                                       sizes:S(13.50), tags:['Fleisch'] },
  { id:'113a', number:'113a', category:'schnitzel', emoji:'🍽️', name:'Schnitzel Spargel Hollandaise',description:'Schinken, Spargel, Hollandaise und Käse überbacken',                            sizes:S(14.00), tags:['Fleisch'] },
  { id:'114',  number:'114',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel al Pepe',           description:'Mit grünem Pfeffer, Sahne',                                                       sizes:S(13.00), tags:['Fleisch'] },
  { id:'114a', number:'114a', category:'schnitzel', emoji:'🍽️', name:'Pfeffer Schnitzel',           description:'Mit grünem Pfeffer, Broccoli, Hollandaise, Knoblauch',                            sizes:S(13.50), tags:['Fleisch'] },
  { id:'115',  number:'115',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel Gambaretti',        description:'Mit Pfifferlingen, Sahnesauce',                                                   sizes:S(13.00), tags:['Fleisch'] },
  { id:'115a', number:'115a', category:'schnitzel', emoji:'🍽️', name:'Schnitzel Pfifferlinge',      description:'Mit Pfifferlingen, Champignons, Hollandaise, Knoblauch',                          sizes:S(13.50), tags:['Fleisch'] },
  { id:'116',  number:'116',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel Spinaci',           description:'Mit Spinat, Sahnesauce und Käse überbacken',                                      sizes:S(13.50), tags:['Fleisch'] },
  { id:'116a', number:'116a', category:'schnitzel', emoji:'🍽️', name:'Schnitzel Broccoli',          description:'Schinken, Broccoli, Hollandaise und Käse überbacken',                             sizes:S(14.00), tags:['Fleisch'] },
  { id:'117',  number:'117',  category:'schnitzel', emoji:'🍽️', name:'Schnitzel Gorgonzola',        description:'Mit Gorgonzolasauce',                                                             sizes:S(13.00), tags:['Fleisch'] },
  { id:'117a', number:'117a', category:'schnitzel', emoji:'🍽️', name:'Zwiebelschnitzel',            description:'Mit gebratenen Zwiebeln',                                                         sizes:S(13.00), tags:['Fleisch'] },
  { id:'117b', number:'117b', category:'schnitzel', emoji:'🍽️', name:'Schnitzel Milano',            description:'Mit Krabben, Pilzen, Knoblauch, Tomaten-Sahnesauce',                              sizes:S(14.00), tags:['Fisch'] },
